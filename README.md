...
J’ai créé une page,  reprenant le code du script le plus lourd. Vous pouvez la consulter <a title="Page BrowserGate" href="https://dsfc.net/browsergate.html" target="_blank"> quel que soit le navigateur  utilisé. Il est assez amusant de voir que Chromium renvoie beaucoup plus d’informations que Firefox. Le nombre de cœurs remonté à partir du navigateur de la fondation Mozilla est faux. La quantité de mémoire utilisée n’est pas remontée par Firefox.
